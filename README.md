...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=00c6ff,0072ff&height=200&section=header&text=Basket&fontSize=70&fontColor=ffffff&animation=twinkling" width="100%" />

<img src="https://img.icons8.com/?id=43605&format=png&size=100" width="90" />

<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&duration=2500&pause=1000&color=00c6ff&center=true&vCenter=true&width=700&height=50&lines=Classification%20App;scikit-learn%20+%20Streamlit;Trainable%20Demo%20Pipeline" alt="Typing SVG" />
...
**Basket** is a classification app scaffold: it trains a scikit-learn/XGBoost model on a
...
```cmd
git clone https://github.com/AfnanSharif/Basket.git
cd Basket
